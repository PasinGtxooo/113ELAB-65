...
// 1สร้างอาร์เรย์เก็บค่าตั้งแต่ 2 - n
// 2เริ่มต้นที่ค่า p = 2
// 3ตัดค่าที่ p หารลงตัวออกให้หมด
// 4หาค่าต่อไปในอาร์เรย์ที่ยังไม่ถูกตัด ค่านี้เป็น prime ตัวต่อไป
// 5ทำข้อ 3-4 ซ้ำจน p ยกกำลัง 2 มากกว่า n
// 6ค่าที่เหลือเป็น prime
